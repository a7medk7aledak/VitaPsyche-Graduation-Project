...
const DoctorProfile: React.FC<DoctorProfileProps> = (props) => {
  const [doctorData, setDoctorData] = useState({
    profileImageUrl: props.profileImageUrl || "/images/unknown-person.jpg", // Default image
    fullNameEn: props.fullNameEn || "Dr. John Doe", // Real data
    fullNameAr: props.fullNameAr || "د. جون دو", // Real data
    ...
    specialization: props.specialization || "Child Psychology", // Real data
    clinicName: props.clinicName || "New York Psychiatry Clinic", // Real data
