...
const DoctorProfile: React.FC<DoctorProfileProps> = ({
    ...
    const [doctorData, setDoctorData] = useState({
        profileImageUrl: profileImageUrl || "/images/unknown-person.jpg", // Default image
        fullNameEn: fullNameEn || "Dr. John Doe", // Default name
        fullNameAr: fullNameAr || "د. جون دو", // Default Arabic name
        specialization: specialization || "Psychiatry", // Default specialization
        clinicName: clinicName || "Unknown Clinic", // Default clinic
