final List<String> imagesOfDoctorsSpecialists = [
  'assets/images/Anxiety_purple.png',
  'assets/images/Ask.png',
  'assets/images/health_problems.png'
];
const String logoApp = 'assets/images/Logo.png';

class ImageApp {
  static const fqas = 'assets/images/fqas.png';
  static const blog = 'assets/images/blogImage.png';
